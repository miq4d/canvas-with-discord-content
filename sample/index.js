...
app.get("/", async (req, res) => {
  ...
  context.fillStyle = "#888888";
  await wt.fillTextWithTwemoji(context, "I am left aligned 😳", 10, 100);

  context.textAlign = "center";
  await wt.fillTextWithTwemoji(context, "我々✨は宇宙人👽だ", 100, 150);

  context.textAlign = "right";
  await wt.fillTextWithTwemoji(context, "I am right aligned 😳", 190, 200);
